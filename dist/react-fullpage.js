...
var anObject = __webpack_require__(11);
var $flags = __webpack_require__(42);
var DESCRIPTORS = __webpack_require__(3);
var TO_STRING = 'toString';
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var core_js_modules_es6_string_iterator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(93);
...
/* harmony import */ var core_js_modules_es6_array_from__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(85);
...
/* harmony import */ var core_js_modules_es6_regexp_to_string__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(78);
/* harmony import */ var core_js_modules_es6_regexp_to_string__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_regexp_to_string__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var core_js_modules_es7_symbol_async_iterator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(41);
...
/* harmony import */ var core_js_modules_es6_symbol__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(38);
/* harmony import */ var core_js_modules_es6_symbol__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_symbol__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(72);
/* harmony import */ var core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var core_js_modules_es6_array_iterator__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(34);
...
/* harmony import */ var core_js_modules_es6_object_keys__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(70);
...
/* harmony import */ var core_js_modules_es7_array_includes__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(68);
...
/* harmony import */ var core_js_modules_es6_string_includes__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(67);
...
/* harmony import */ var core_js_modules_es6_array_find__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(63);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(2);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var fullpage_js_dist_fullpage_min_css__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(59);
/* harmony import */ var fullpage_js_dist_fullpage_min_css__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(fullpage_js_dist_fullpage_min_css__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _Logger__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(23);
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(6);
...
var Fullpage;// CHECKS IF IS A VALID FUNCTION
var isFunc=function isFunc(val){return typeof val==='function';};// FUNNCTION TO COMPARE TWO ARRAYS
var isEqualArray=function isEqualArray(firstArr,secondArr){// IF LENGHT IS DIFFERENT THEN IS AUTOMATICALLY NOT THE SAME
if(firstArr.length!==secondArr.length)return false;return firstArr.find(function(el){return!secondArr.includes(el);})==null;};// ARRAY OF CALLBACK FUNCTIONS
var fullpageCallbacks=['afterLoad','afterRender','afterResize','afterResponsive','afterSlideLoad','onLeave','onSlideLeave'];// REACT CLASS FOR FULLPAGE WRAPPER DEFINED
var ReactFullpage=/*#__PURE__*/function(_React$Component){_inherits(ReactFullpage,_React$Component);// CONSTRUCTOR CREATED
function ReactFullpage(props){var _this;_classCallCheck(this,ReactFullpage);_this=_possibleConstructorReturn(this,_getPrototypeOf(ReactFullpage).call(this,props));var _this$props=_this.props,render=_this$props.render,pluginWrapper=_this$props.pluginWrapper;// CHECKS IF THE RENDER PROPS IS USED
if(!isFunc(render)){// IF NOT THEN IT RETURNS AN ERROR
throw new Error('must provide render prop to <ReactFullpage />');}_this.log=Object(_Logger__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(_this.props.debug,'ReactFullpage');_this.log('Building component');_this.log('Importing vendor files');// VERIFIES IF scrollOverflow IS SET AS PROPS
_this.importVendors();// CHECKS IF PLUGIN WRAPPER IT'S NEEDED
if(pluginWrapper){_this.log('Calling plugin wrapper');pluginWrapper();}// LOAD THE MIN VER OF FULLPAGE
_this.log('Requiring fullpage.js');Fullpage=__webpack_require__(54);// INITIALIZED STATE
_this.state={initialized:false,sectionCount:0,slideCount:0};return _this;}_createClass(ReactFullpage,[{key:"componentDidMount",value:function componentDidMount(){// GET OPTIONS SET IN REACT IMPLEMENTATION
var opts=this.buildOptions();this.log('React Lifecycle: componentDidMount()');// IF FULLPAGE EXIST THEN INITIALIZE IT
if(Fullpage){this.init(opts);this.markInitialized();}}},{key:"componentDidUpdate",value:function componentDidUpdate(prevProps){this.log('React Lifecycle: componentDidUpdate()');var newSectionCount=this.getSectionCount();var newSlideCount=this.getSlideCount();var newSlideContent=this.getSlideContent();var _this$state=this.state,sectionCount=_this$state.sectionCount,slideCount=_this$state.slideCount,slideContent=_this$state.slideContent;// comparing sectionColors array option
...
if(!areSameSectionColors){this.log('rebuilding due to a change in fullpage.js props');this.reRender();return;}// compare old slide content vs new slide content
var isSameContent=isEqualArray(slideContent,newSlideContent);var slidesContainSameContent=slideContent.length>0&&isSameContent;this.log('isSameContent:'+isSameContent,this.state);if(sectionCount===newSectionCount&&slideCount===newSlideCount&&slidesContainSameContent){return;}else{this.log('rebuilding due to a change in fullpage.js sections/slides');this.reRender();}// NOTE: if sections/slides have changed we need to rebuild
}},{key:"componentWillUnmount",value:function componentWillUnmount(){this.destroy();}},{key:"getSectionCount",value:function getSectionCount(){var _this$props$sectionSe=this.props.sectionSelector,sectionSelector=_this$props$sectionSe===void 0?_selectors__WEBPACK_IMPORTED_MODULE_14__[/* DEFAULT_SECTION */ "a"]:_this$props$sectionSe;var _document$querySelect=document.querySelectorAll(sectionSelector),length=_document$querySelect.length;return length;}},{key:"getSlideCount",value:function getSlideCount(){var _this$props$slideSele=this.props.slideSelector,slideSelector=_this$props$slideSele===void 0?_selectors__WEBPACK_IMPORTED_MODULE_14__[/* DEFAULT_SLIDE */ "b"]:_this$props$slideSele;var _document$querySelect2=document.querySelectorAll(slideSelector),length=_document$querySelect2.length;return length;}},{key:"getSlideContent",value:function getSlideContent(){var _this$props$slideSele2=this.props.slideSelector,slideSelector=_this$props$slideSele2===void 0?_selectors__WEBPACK_IMPORTED_MODULE_14__[/* DEFAULT_SLIDE */ "b"]:_this$props$slideSele2;var contentArray=_toConsumableArray(document.querySelectorAll(slideSelector)).map(function(slide){return slide.firstChild.firstChild.children;});return contentArray;}},{key:"importVendors",value:function importVendors(){var _this$props2=this.props,scrollOverflow=_this$props2.scrollOverflow,easing=_this$props2.easing;if(scrollOverflow){__webpack_require__(53);}if(easing){__webpack_require__(52);}}},{key:"init",value:function init(opts){this.log('Reinitializing fullpage with options',opts);new Fullpage(_selectors__WEBPACK_IMPORTED_MODULE_14__[/* ID_SELECTOR */ "c"],opts);// eslint-disable-line
this.fullpageApi=window.fullpage_api;this.fpUtils=window.fp_utils;this.fpEasings=window.fp_easings;this.log('this.fpUtils',this.fpUtils);this.markInitialized();}},{key:"destroy",value:function destroy(){this.log('Destroying fullpage instance');this.fullpageApi.destroy('all');}},{key:"reRender",value:function reRender(){this.destroy();this.init(this.buildOptions());}},{key:"markInitialized",value:function markInitialized(){this.log('Marking initialized');this.setState({initialized:true,sectionCount:this.getSectionCount(),slideCount:this.getSlideCount(),slideContent:this.getSlideContent()});}},{key:"buildOptions",value:function buildOptions(){var _this2=this;var filterCb=function filterCb(key){return!!Object.keys(_this2.props).find(function(cb){return cb===key;});};var registered=fullpageCallbacks.filter(filterCb);var listeners=registered.reduce(function(result,key){return _objectSpread({},result,_defineProperty({},key,function(){for(var _len=arguments.length,args=new Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _this2.update.apply(_this2,[key].concat(args));}));},{});// NOTE: override passed in callbacks w/  wrapped listeners
...
case'onLeave':state=makeState(fromArgs(['origin','destination','direction']));break;case'onSlideLeave':state=makeState(fromArgs(['section','origin','slideIndex','destination','direction']));break;default:break;}var returned=(_this$props3=this.props)[lastEvent].apply(_this$props3,args);this.log('Called callback: Returning => ',returned);this.log('Updating State => ',state);this.setState(state);return returned;}},{key:"render",value:function render(){this.log('<== Rendering ==>');return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div",{id:_selectors__WEBPACK_IMPORTED_MODULE_14__[/* MAIN_SELECTOR */ "d"]},this.props.render(this));}}]);return ReactFullpage;}(react__WEBPACK_IMPORTED_MODULE_11___default.a.Component);ReactFullpage.defaultProps={sectionsColor:[]};/* harmony default export */ __webpack_exports__["default"] = (ReactFullpage);
